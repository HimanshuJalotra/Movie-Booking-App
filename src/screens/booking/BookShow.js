...
export default function BookShow() {
    ...
    const [inValue,finValue] = useState("0");
  ...
  return (
    <div>
        ...
        <p></p>
        <div>
        <Card sx={{ width: "400px", minHeight: "440px" }} style={{margin:"auto"}}>
        <CardContent>
          ...
          <br />
          <br />
          <TextField id="outlined-select-currency" select label="Location" value={genres} onChange={handleChange} style={{width:"100%"}} >
          ...
          <br />
          <br />
          <TextField id="outlined-select-currency" select label="Show Date" value={genres} onChange={handleChange} style={{width:"100%"}} >
            {genresArr.map((option) => (
              <MenuItem key={option.name} value={option.name}>
                {option.name}
              </MenuItem>
          ...
          <br />
          <br />
          <TextField id="outlined-select-currency" select label="Show Time" value={genres} onChange={handleChange} style={{width:"100%"}} >
            {genresArr.map((option) => (
              <MenuItem key={option.name} value={option.name}>
                {option.name}
              </MenuItem>
          ...
          <TextField required id="filled-required" label="Tickets" variant="standard" style={{width:"100%"}} onChange={event => finValue(event.target.value*500)} />
          <br/>
          <br />
          Unit Price : Rs 500
          <br />
          Total Price : Rs {inValue}
          <br />
        </CardContent>
        <CardActions>
          <Button size="small" variant="contained" style={{width:"120px",marginLeft:"10px"}}>BOOK SHOW</Button>
        </CardActions>
      </Card>
        </div>
    </div>
