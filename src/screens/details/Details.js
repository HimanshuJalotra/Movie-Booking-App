...
export default function Details(props) {
  let artistsArr = props.data.artists;
  const opts = {
    height: '350px',
    width: '92%',
    playerVars: {
    ...
    <div style={{ marginTop: "0px" }}>
      <div className="main">
        ...
        <div className="mid">
          ...
          <Button size="small" variant="contained" style={{width:"120px",height:"40px"}}><Link to="/booking" style={{color:"white",textDecoration:"none"}}>BOOK SHOW</Link></Button>
                <h4>{props.data.title}</h4>
              </Typography>
              <Typography variant="subtitle1" gutterBottom>
                <b> Genre </b>: <i>{props.data.genre}</i>
              </Typography>
              <Typography variant="subtitle1" gutterBottom>
                <b>Duration: </b>
                <i> {props.data.duration} </i>
              </Typography>
              <Typography variant="subtitle1" gutterBottom>
                <b> Release Date: </b> <i>{props.data.relDate}</i>
              </Typography>
              <Typography variant="subtitle1" gutterBottom>
                <b>Rating:</b> <i>{props.data.rating}</i>
              </Typography>
              <Typography variant="subtitle1" gutterBottom>
                <b>Plot: </b> <i>{props.data.plot} </i>
              </Typography>
            </Box>
          </div>
          <div className="mid-bottom">
            <h3>Trailer</h3>
            <YouTube
              videoId={props.data.videoUrl.slice(33,44)}
              // id={}
              opts={opts}
              // onReady={}
              // onPlay={}
        ...
        <div className="right">
          <Box sx={{ width: "100%", maxWidth: 500 }}>
            ...
            <Typography variant="h5" gutterBottom>
                ...
                Artists
              <ImageList sx={{ width: "100%", height: 420 }}>
    ...
    artists: [
      {
        ...
        role_type: "ACTOR",
        profile_description:
          "Anthony M. LaPaglia is an Australian actor. He played the role of Joe in the coming of age comedy Empire Records and John in the film Autumn In New York, as well as FBI agent Jack Malone on the American TV series Without a Trace, for which he won a Golden Globe Award for Best Actor Ã¢â‚¬â€œ Television Series Drama. He also appeared in 8 episodes of Frasier as Daphne Moon's alcoholic brother Simon.",
        profile_url:
